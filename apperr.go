...
func Canceled(msg string, opts ...Option) error {
...
func InvalidArgument(msg string, opts ...Option) error {
...
func DeadlineExceeded(msg string, opts ...Option) error {
...
func ResourceExhausted(msg string, opts ...Option) error {
...
func FailedPrecondition(msg string, opts ...Option) error {
...
func Aborted(msg string, opts ...Option) error {
...
// they are done.
func OutOfRange(msg string, opts ...Option) error {
	return newAppError(code.OutOfRange, msg, opts)
}

// Unimplemented indicates operation is not implemented or not
// supported/enabled in this service.
func Unimplemented(msg string, opts ...Option) error {
...
func DataLoss(msg string, opts ...Option) error {
